...
Archivo de proposiciones - Números por paridad

Convenciones :
  MT : Surgen varías metas pero algunas de estas son triviales

Importación del archivo de definiciones de BN
ArithRing se usa para verificar propiedades de nat
*)
...
Proof.
  ...
  + intros.
    destruct a.
    - constructor.
    - inversion H. subst. apply lt_noZ in H2. contradiction.
    - inversion H. subst. apply lt_noZ in H2. contradiction.
  + intros.
    destruct a. 
    - do 2 constructor.
    - simpl in H. inversion H.
      * subst. constructor.
      * subst. do 2 constructor. auto.
    - simpl in H. inversion H. subst. repeat constructor. auto.
  + intros.
    destruct a.
    - repeat constructor.
    - simpl in H. inversion H. subst. 
      specialize (IHb a). apply IHb in H2.
      inversion H2.
...
Proof.
  ...
  + intros. destruct b.
    ...
    - specialize (IHa b). destruct IHa.
      ...
      destruct H. right. left. apply f_equal. auto.
      repeat right. constructor. auto.
    - specialize (IHa b). destruct IHa.
      left. constructor. auto.
      destruct H. left. rewrite H. constructor.
      repeat right. constructor. auto.
  + intros. destruct b.
    - repeat right. constructor. 
    - specialize (IHa b). destruct IHa.
      left. constructor. auto.
      destruct H. repeat right. rewrite H. constructor.
      repeat right. constructor. auto.
    - specialize (IHa b). destruct IHa.
      left. constructor. auto.
      destruct H. right. left. rewrite H. auto.
      repeat right. constructor. auto.
Qed.
...
Proof.
  ...
  + do 2 destruct H.
    ...
    - subst. apply ltBN_arefl in H. auto.
    - subst. apply lt_noZ in H3. auto.
    - subst. apply lt_noZ in H3. auto.
  + do 2 destruct H.
    destruct x.
    - apply lt_noZ in H. auto.
    - simpl in H0. inversion H. subst.
      inversion H0. subst.
      * apply ltBN_arefl in H3. auto.
      * assert (a <BN a).
          apply (ltBN_trans _ x _ ); auto.
        apply ltBN_arefl in H5. auto.
    - simpl in H0. inversion H. 
...
(*
Cualquier elemento mayor a cero, difiere de cero
*)
Lemma lt_Z_diff : 
forall a : BN,
Z <BN a -> a <> Z.
...
(*
Un elemento mayor que cero es mayor a su predecesor
*)
...
(*
El orden estricto implica el orden suave
*)
Lemma lt_imp_lteq :
forall ( a b : BN),
a <BN b -> a ≤BN b.
...
(*
Si un número no es cero, se pueden intercambiar el sucesor y predecesor
*)
...
Proof.
  ...
  + intros. 
    (* MT *)
    destruct a; auto.
     specialize ( ZnotU_sym a ) as HA.
     assert ( HB : predBN (U (U a )) = D (predBN  (U a))). 
      { auto. }
     rewrite HB.
     assert ( HC : sucBN (D (predBN (U a)))  = U (sucBN (predBN (U a)))).
      { auto. }
     rewrite HC.
     apply IHa in HA.
     rewrite HA.
  ...
  + intros. 
    (* MT *)
    destruct a; auto.
     specialize ( ZnotD_sym a ) as HA.
     apply IHa in HA.
     assert ( HB : sucBN (D (D a)) = U ( sucBN ( D a))). 
     { auto. }
     rewrite HB.
     assert ( HC : predBN (U (sucBN (D a))) = D (predBN (sucBN (D a)))). 
     { auto. }
     rewrite HC.
     rewrite <- HA.
     auto.
...
(*
Sumar cualquier cosa a algo que no es cero, es no cero
*)
Lemma plus_Ub_notZ : 
forall a b : BN,
a ⊞ U b <> Z.
...
(*
Dado un número no cero b, sumar el predecesor de b con algo es lo mismo que tomar el predecesor de la suma
*)
Lemma plusPred : 
forall a b : BN ,
  ...
  + intros. destruct b.
    ...
    - destruct b.
      * simpl.
        ...
        auto.
      * specialize ( ZnotU_sym b) as H0. 
        assert ( predBN (U ( U b )) = D ( predBN ( U b))). 
          { auto. }
        rewrite H1.
        specialize ( IHa (U b) ).
        ...
        apply plus_Ub_notZ.
      * specialize ( ZnotD_sym b ) as H0. 
        assert ( predBN (U ( D b )) = D ( predBN ( D b))). 
         { auto. }
        rewrite H1.
        assert ( U a ⊞ D (predBN (D b)) = U( sucBN ( a ⊞ predBN (D b) )) ).
         { auto. }
        rewrite H2.
        specialize (IHa (D b)).
        apply IHa in H0 as HT.
  ...
  + intros.
    ...
    - destruct b.
      ...
      * specialize ( ZnotU_sym b) as H0.
        ...
        rewrite H1.
        specialize (IHa (U b)).
        assert ( D a ⊞ D (predBN (U b)) = D ( sucBN ( a ⊞ predBN (U b)))).
         { auto. }
        rewrite H2.
        apply IHa in H0 as HT.
        rewrite HT.
        assert ( D a ⊞ U (U b) =   U(sucBN ( a ⊞ (U b)))). 
         { auto. }
        rewrite H3.
        simpl.
        destruct (bnNonZ (sucBN (a ⊞ U b))). 
        apply ZnotSucBN_sym.
        assert ( a ⊞ U b <> Z). 
        apply plus_Ub_notZ.
        destruct H4; 
      ...
      * simpl.
        assert ( sucBN (a ⊞ U b) = a ⊞ (D b)). 
         { rewrite (plusComm a (U b)).
           rewrite plusSuc. 
           rewrite (plusComm (sucBN (U b)) a). 
           auto. }
        destruct (bnNonZ (sucBN (a ⊞ D b))).
        apply ZnotSucBN_sym.
        destruct H1;
...
Proof.
  ...
  rewrite (plusComm b a); auto.
Qed.


(*
Dado un número que no es cero, y una igualdad es posible intercambiar el sucesor con el predecesor
*)
